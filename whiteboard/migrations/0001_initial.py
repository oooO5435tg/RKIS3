# Generated by Django 4.2.7 on 2023-12-26 22:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('text', models.TextField()),
                ('pict', models.ImageField(blank=True, upload_to='')),
                ('parent', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='parent_comment', to='whiteboard.comment', verbose_name='parent comment')),
